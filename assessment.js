...
console.assert(
  assessment('次郎')===
  '次郎のいいところは自制心です。やばいと思った時にしっかりと衝撃を抑えられる次郎がみんなから評価されています。',
  '診断結果の文言の特定の部分を名前に置き換える処理が正しくありません。'
);
...
console.assert(
  ...
  '診断結果の文言の得点の部分を名前にう置き換える処理が正しくありません。'
);
...
console.log('同じ名前なら、同じ結果を出力することテスト終了');
}
